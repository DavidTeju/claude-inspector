...
>
	...
	{#if !isNearBottom}
		<button
			...
			class="border-border bg-accent text-foreground/80 hover:bg-surface-700 absolute bottom-4 left-1/2 -translate-x-1/2 cursor-pointer rounded-full border px-3 py-1.5 text-[10px] shadow-lg transition-colors"
		>
			Jump to bottom
		</button>
	{/if}
