...
<div class="relative" bind:this={containerEl}>
	<button
		...
		class="text-base-content/50 hover:text-base-content/70 cursor-pointer font-mono text-[10px] transition-colors"
	>
	...
	{#if expanded}
		<div
			class="card border-base-content/15 bg-base-300 absolute top-full right-0 z-10 mt-1 border p-3 shadow-lg"
		>
			<table class="text-[10px]">
				<tbody>
					...
					<tr class="border-base-content/15 border-t">
						<td class="text-base-content/70 pt-1 pr-4 font-semibold">Total</td>
						<td class="text-base-content pt-1 text-right font-mono">{formattedTotal}</td>
					</tr>
				</tbody>
			</table>

			{#if hasMultipleModels}
				<div class="border-base-content/15 mt-2 border-t pt-2">
